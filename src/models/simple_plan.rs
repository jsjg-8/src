...
pub struct SimplePlan {
    ...
    #[serde(rename = "trialTimeUnit", skip_serializing_if = "Option::is_none")]
    pub trial_time_unit: Option<TrialTimeUnit>,
    #[serde(rename = "availableBaseProducts", skip_serializing_if = "Option::is_none")]
    pub available_base_products: Option<Vec<String>>,
}

impl SimplePlan {
    pub fn new() -> SimplePlan {
        SimplePlan {
            plan_id: None,
            product_name: None,
            ...
            billing_period: None,
            trial_length: None,
            trial_time_unit: None,
            available_base_products: None,
        }
    }
}
/// 
...
impl Default for TrialTimeUnit {
    fn default() -> TrialTimeUnit {
        Self::Days
    }
}
